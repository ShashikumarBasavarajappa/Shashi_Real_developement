Mail_sender: Kitchensink Example using Spring 4.x
==============================================================
Author: Marius Bogoevici, Tejas Mehta, Joshua Wilson  
Level: Intermediate  
Technologies: JSP, JPA, JSON, Spring, JUnit  
Summary: The `Mail_sender` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x.  
Target Product: WFK  
...
The `Mail_sender` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x. It 
...
4. This will deploy `target/Mail_sender.war` to the running instance of the server.


Access the application
----------------------

The application will be running at the following URL: <http://localhost:8080/Mail_sender/>.
